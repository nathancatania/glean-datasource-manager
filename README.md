...
## TOC
- [Glean Custom Datasource Manager CLI](#glean-custom-datasource-manager-cli)
  ...
  - [Troubleshooting](#troubleshooting)
    - ["Icon file not found" Error](#icon-file-not-found-error)
    - ["Datasource already exists" Error](#datasource-already-exists-error)
